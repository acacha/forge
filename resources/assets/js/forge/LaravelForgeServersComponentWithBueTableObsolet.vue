                        ...
                        <tr v-for="(server, index) in servers">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button @click="unassign" :disabled='isUnassigning' type="button" class="btn btn-danger">Unassign</button>
                                    <button v-if="server.state === 'pending'" type="button" class="btn btn-info">Validate</button>
                                    <button v-else type="button" class="btn btn-danger">Unvalidate</button>
                                </div>
                            </td>
                        </tr>
                        </tbody>
